      ...
      <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
        ...
        <div style={{ flex:1, overflowY:"auto", padding:28 }}>
          {loading ? (
            ...
            <PatientsTab patients={patients} rbts={rbts} getRBTsForPatient={getRBTsForPatient} onAssign={assignRBT} onUnassign={unassignRBT} onEdit={editPatient} expanded={expanded} setExpanded={setExpanded} onViewDashboard={(p)=>{setDashboardPatient(p);setTab("dashboard");}} />
          ) : tab==="programs" ? (
